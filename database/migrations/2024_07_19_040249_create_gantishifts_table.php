...
return new class extends Migration
{
    ...
    {
        Schema::create('hrd_gantishift', function (Blueprint $table) {
            $table->char('kode_gs', 7)->primary();
            $table->date('tanggal');
            $table->char('nik', 9);
            ...
            $table->foreign('kode_jadwalshift')->references('kode_jadwalshift')->on('hrd_jadwalshift')->restrictOnDelete()->cascadeOnUpdate();
            $table->timestamps();
        });
    }
    ...
    {
        Schema::dropIfExists('hrd_gantishift');
    }
};
