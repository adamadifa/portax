                ...
                <div class="col">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <x-input-with-icon label="Supplier" name="nama_supplier" icon="ti ti-building-store"
                                readonly="true" />
...
<div class="modal fade" id="modalSupplier" tabindex="-1" data-bs-backdrop="static" data-bs-keyboard="false"
    aria-hidden="true">
        ...
        $('#tabelsupplier').DataTable({
            ...
            initComplete: function() {
                this.api().columns().every(function(index) {
                    if (index == 2 || index ==
                        3
                    ) { // Only add search inputs for nama_supplier and nama_salesman columns
                        var column = this;
            ...
            rowCallback: function(row, data, index) {
                if (data.status_supplier == "NonAktif") {
