<form id="formBayar" method="POST" action="{{ route('pembayaranpembelianmarketing.store', Crypt::encrypt($no_bukti)) }}">
    @csrf
    ...
    <x-select label="Jenis Bayar" name="jenis_bayar" :data="[['value' => 'TN', 'text' => 'CASH'], ['value' => 'TR', 'text' => 'TRANSFER']]" key="value" textShow="text" upperCase="true" select2="select2Jenisbayar" />
