<form action="{{ route('laporanmarketing.cetakkartupiutang') }}" method="POST" target="_blank" id="formKartupiutang" class="space-y-3">
    @csrf
    ...
    <div class="grid grid-cols-1 md:grid-cols-12 gap-x-4 gap-y-1">
        ...
        <div class="md:col-span-12">
            <div class="relative group">
                ...
                <select name="kode_cabang" id="kode_cabang_kartupiutang" class="w-full pl-10 pr-3 py-2 bg-white border border-slate-300 rounded-lg text-sm focus:outline-none focus:border-[#003d9e] focus:ring-1 focus:ring-[#003d9e] transition-colors appearance-none select2Kodecabangkartupiutang">
        ...
        <div class="md:col-span-12">
            <div class="relative group">
                ...
                <select name="kode_salesman" id="kode_salesman_kartupiutang" class="w-full pl-10 pr-3 py-2 bg-white border border-slate-300 rounded-lg text-sm focus:outline-none focus:border-[#003d9e] focus:ring-1 focus:ring-[#003d9e] transition-colors appearance-none select2Kodesalesmankartupiutang">
                </select>
            </div>
        </div>
        ...
        <div class="md:col-span-12">
            <div class="relative group">
                ...
                <select name="kode_pelanggan" id="kode_pelanggan_kartupiutang" class="w-full pl-10 pr-3 py-2 bg-white border border-slate-300 rounded-lg text-sm focus:outline-none focus:border-[#003d9e] focus:ring-1 focus:ring-[#003d9e] transition-colors appearance-none select2Kodepelanggankartupiutang">
                </select>
            </div>
        </div>
