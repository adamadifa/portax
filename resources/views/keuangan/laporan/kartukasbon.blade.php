    ...
    <div class="grid grid-cols-1 md:grid-cols-12 gap-x-4 gap-y-1">
        @hasanyrole($roles_show_cabang_pjp)
            <div class="md:col-span-12 relative">
                ...
                <select name="kode_cabang_kartukasbon" id="kode_cabang_kartukasbon"
                    class="w-full pl-10 pr-3 py-2 bg-white border border-slate-200 rounded-lg text-sm focus:outline-none focus:border-[#003d9e] focus:ring-4 focus:ring-[#003d9e]/5 transition-all appearance-none select2Kodecabangkartukasbon font-medium text-slate-700">
            ...
            <div class="md:col-span-12 relative">
                ...
                <select name="kode_dept_kartukasbon" id="kode_dept_kartukasbon"
                    class="w-full pl-10 pr-3 py-2 bg-white border border-slate-200 rounded-lg text-sm focus:outline-none focus:border-[#003d9e] focus:ring-4 focus:ring-[#003d9e]/5 transition-all appearance-none select2Kodedeptkartukasbon font-medium text-slate-700">
        ...
        <div class="md:col-span-6 relative">
            ...
            <select name="bulan" id="bulan_kartukasbon"
        ...
        <div class="md:col-span-6 relative">
            ...
            <select name="tahun" id="tahun_kartukasbon"
                class="w-full pl-10 pr-3 py-2 bg-white border border-slate-200 rounded-lg text-sm focus:outline-none focus:border-[#003d9e] focus:ring-4 focus:ring-[#003d9e]/5 transition-all appearance-none form-select font-medium text-slate-700">
...
@push('myscript')
    <script>
        $(function() {
            ...
            const select2Kodedeptkartukasbon = $(".select2Kodedeptkartukasbon");
            if (select2Kodedeptkartukasbon.length) {
                select2Kodedeptkartukasbon.each(function() {
                    var $this = $(this);
                    $this.wrap('<div class="position-relative"></div>').select2({
            ...
            formKartukasbon.submit(function(e) {
                const bulan = formKartukasbon.find("#bulan_kartukasbon").val();
                const tahun = formKartukasbon.find("#tahun_kartukasbon").val();
                if (bulan == "") {
                    Swal.fire({
                        title: "Oops!",
                        ...
                        didClose: (e) => {
                            formKartukasbon.find("#bulan_kartukasbon").focus();
                        },
                    });
                    return false;
                } else if (tahun == "") {
                    Swal.fire({
                        ...
                        showConfirmButton: true,
                        didClose: (e) => {
                            formKartukasbon.find("#tahun_kartukasbon").focus();
                        },
                    });
                    return false;
                }
