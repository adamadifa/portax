    ...
    <div class="grid grid-cols-1 md:grid-cols-12 gap-x-4 gap-y-1">
        @hasanyrole($roles_show_cabang)
            <div class="md:col-span-12 relative">
                ...
                <select name="kode_cabang_kartupiutangkaryawan" id="kode_cabang_kartupiutangkaryawan"
                    class="w-full pl-10 pr-3 py-2 bg-white border border-slate-200 rounded-lg text-sm focus:outline-none focus:border-[#003d9e] focus:ring-4 focus:ring-[#003d9e]/5 transition-all appearance-none select2Kodecabangkartupiutangkaryawan font-medium text-slate-700">
            ...
            <div class="md:col-span-12 relative">
                ...
                <select name="kode_dept_kartupiutangkaryawan" id="kode_dept_kartupiutangkaryawan"
                    class="w-full pl-10 pr-3 py-2 bg-white border border-slate-200 rounded-lg text-sm focus:outline-none focus:border-[#003d9e] focus:ring-4 focus:ring-[#003d9e]/5 transition-all appearance-none select2Kodedeptkartupiutangkaryawan font-medium text-slate-700">
        ...
        <div class="md:col-span-6 relative">
            ...
            <select name="bulan" id="bulan_kartupiutangkaryawan"
        ...
        <div class="md:col-span-6 relative">
            ...
            <select name="tahun" id="tahun_kartupiutangkaryawan"
                class="w-full pl-10 pr-3 py-2 bg-white border border-slate-200 rounded-lg text-sm focus:outline-none focus:border-[#003d9e] focus:ring-4 focus:ring-[#003d9e]/5 transition-all appearance-none form-select font-medium text-slate-700">
...
@push('myscript')
    <script>
        $(function() {
            ...
            const select2Kodedeptkartupiutangkaryawan = $(".select2Kodedeptkartupiutangkaryawan");
            if (select2Kodedeptkartupiutangkaryawan.length) {
                select2Kodedeptkartupiutangkaryawan.each(function() {
                    var $this = $(this);
                    $this.wrap('<div class="position-relative"></div>').select2({
            ...
            formKartupiutangkaryawan.submit(function(e) {
                const bulan = formKartupiutangkaryawan.find("#bulan_kartupiutangkaryawan").val();
                const tahun = formKartupiutangkaryawan.find("#tahun_kartupiutangkaryawan").val();
                if (bulan == "") {
                    Swal.fire({
                        title: "Oops!",
                        ...
                        didClose: (e) => {
                            formKartupiutangkaryawan.find("#bulan_kartupiutangkaryawan").focus();
                        },
                    });
                    return false;
                } else if (tahun == "") {
                    Swal.fire({
                        ...
                        showConfirmButton: true,
                        didClose: (e) => {
                            formKartupiutangkaryawan.find("#tahun_kartupiutangkaryawan").focus();
                        },
                    });
                    return false;
                }
