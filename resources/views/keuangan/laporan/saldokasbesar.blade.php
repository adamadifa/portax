    ...
    <div class="grid grid-cols-1 md:grid-cols-1 gap-x-4 gap-y-1">
        @hasanyrole($roles_show_cabang)
            <div class="relative">
                ...
                <select name="kode_cabang_saldokasbesar" id="kode_cabang_saldokasbesar"
                    class="w-full pl-10 pr-3 py-2 bg-white border border-slate-200 rounded-lg text-sm focus:outline-none focus:border-[#003d9e] focus:ring-4 focus:ring-[#003d9e]/5 transition-all appearance-none select2Kodecabangsaldokasbesar font-medium text-slate-700">
        ...
        <div class="relative">
            ...
            <select name="bulan" id="bulan_saldokasbesar"
        ...
        <div class="relative">
            ...
            <select name="tahun" id="tahun_saldokasbesar"
                class="w-full pl-10 pr-3 py-2 bg-white border border-slate-200 rounded-lg text-sm focus:outline-none focus:border-[#003d9e] focus:ring-4 focus:ring-[#003d9e]/5 transition-all appearance-none form-select font-medium text-slate-700">
    ...
    <script>
        $(function() {
            ...
            formSaldokasbesar.submit(function(e) {
                ...
                const bulan = formSaldokasbesar.find("#bulan_saldokasbesar").val();
                const tahun = formSaldokasbesar.find("#tahun_saldokasbesar").val();
                if (kode_cabang == "" && formSaldokasbesar.find("#kode_cabang_saldokasbesar").length > 0) {
                    Swal.fire({
                        title: "Oops!",
                    ...
                    Swal.fire({
                        ...
                        showConfirmButton: true,
                        didClose: (e) => {
                            formSaldokasbesar.find("#bulan_saldokasbesar").focus();
                        },
                    });
                    return false;
                } else if (tahun == "") {
                    Swal.fire({
                        ...
                        showConfirmButton: true,
                        didClose: (e) => {
                            formSaldokasbesar.find("#tahun_saldokasbesar").focus();
                        },
                    });
                    return false;
                }
