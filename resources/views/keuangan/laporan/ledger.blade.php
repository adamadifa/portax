<form action="{{ route('laporankeuangan.cetakledger') }}" id="formLedger" target="_blank" method="POST" class="space-y-3">
    @csrf
    <div class="grid grid-cols-1 md:grid-cols-12 gap-x-4 gap-y-1">
        <div class="md:col-span-12 relative">
            ...
            <select name="kode_bank_ledger" id="kode_bank_ledgers"
                class="w-full pl-10 pr-3 py-2 bg-white border border-slate-200 rounded-lg text-sm focus:outline-none focus:border-[#003d9e] focus:ring-4 focus:ring-[#003d9e]/5 transition-all appearance-none select2Kodebankledgers font-medium text-slate-700">
        ...
        <div class="md:col-span-12 grid grid-cols-2 gap-4" id="coa">
            <div class="relative">
                <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none z-10">
                    <i class="ti ti-list text-slate-400"></i>
                </div>
                <select name="kode_akun_dari" id="kode_akun_dari"
                    class="w-full pl-10 pr-3 py-2 bg-white border border-slate-200 rounded-lg text-sm focus:outline-none focus:border-[#003d9e] focus:ring-4 focus:ring-[#003d9e]/5 transition-all appearance-none select2Kodeakundari font-medium text-slate-700">
            ...
            <div class="relative">
                ...
                <select name="kode_akun_sampai" id="kode_akun_sampai"
                    class="w-full pl-10 pr-3 py-2 bg-white border border-slate-200 rounded-lg text-sm focus:outline-none focus:border-[#003d9e] focus:ring-4 focus:ring-[#003d9e]/5 transition-all appearance-none select2Kodeakunsampai font-medium text-slate-700">
                    <option value="">Semua Akun</option>
                    @foreach ($coa as $d)
                        <option value="{{ $d->kode_akun }}">{{ $d->kode_akun }} {{ $d->nama_akun }}
                        </option>
