...
<div class="d-flex justify-content-end">
    <a href="{{ route('pembayarankasbon.show', [Crypt::encrypt($potongankasbon->kode_potongan), 'true']) }}" class="btn btn-success mb-3"
        target="_blank">
        <i class="ti ti-download me-1"></i>Export Excel</a>
</div>
<div class="row mb-3">
    <dv class="col">
        <table class="table">
