@extends('layouts.app')
@section('titlepage', 'Saldo Awal Muasi Keuangan')
@section('content')
@section('navigasi')
    <span>Saldo Awal Mutasi Keuangan</span>
@endsection
<div class="row">
    <div class="col-lg-10">
...
<script>
    $(function() {
        ...
        $("#btnCreate").click(function(e) {
            e.preventDefault();
            $("#modal").modal("show");
            $("#modal").find(".modal-title").text("Buat Saldo Awal Mutasi Keuangan");
            $("#loadmodal").load(`/samutasikeuangan/create`);
        });
