<form action="{{ route('mutasibank.store') }}" method="POST" id="formMutasibank">
    ...
    <div class="mb-4 relative">
        ...
        <textarea name="keterangan" id="keterangan" rows="3" class="w-full px-3 py-2.5 bg-white border border-slate-300 rounded-lg text-sm placeholder-slate-400 focus:outline-none focus:border-[#003d9e] focus:ring-1 focus:ring-[#003d9e] transition-colors" placeholder="Keterangan transaksi..."></textarea>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-12 gap-4 mb-4">
        ...
        <div class="md:col-span-8 relative">
            ...
            <input type="text" name="jumlah" id="jumlah" class="money text-right w-full px-3 py-2.5 bg-white border border-slate-300 rounded-lg text-sm placeholder-slate-400 focus:outline-none focus:border-[#003d9e] focus:ring-1 focus:ring-[#003d9e] transition-colors font-medium" placeholder="0">
        </div>
