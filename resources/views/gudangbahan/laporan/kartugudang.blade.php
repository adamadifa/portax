...
@push('myscript')
   <script>
      $(function() {
         const select2Kodebarangkartugudang = $('.select2Kodebarangkartugudang');
         if (select2Kodebarangkartugudang.length) {
            select2Kodebarangkartugudang.each(function() {
               var $this = $(this);
         ...
         $("#frmKartugudang").submit(function() {
            const bulan = $(this).find("#bulan").val();
            const tahun = $(this).find("#tahun").val();
            const kode_barang = $(this).find("#kode_barang_kartugudang").val();
            if (bulan == "") {
               Swal.fire({
                  title: "Oops!",
               ...
               Swal.fire({
                  ...
                  showConfirmButton: true,
                  didClose: (e) => {
                     $(this).find("#kode_barang_kartugudang").focus();
                  },
               });
               return false;
            }
