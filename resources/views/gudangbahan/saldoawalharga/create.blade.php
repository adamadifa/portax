@extends('layouts.app')
@section('titlepage', 'Buat Saldo Awal Harga Gudang Bahan')

@section('content')
@section('navigasi')
    <span class="text-muted fw-light">Saldo Awal Harga Gudang Bahan /</span> Buat Saldo Awal
@endsection
...
<div class="row">
    <div class="col-lg-6 col-md-12 col-sm-12 col-xs-12">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('sahargagb.store') }}" method="POST" id="formCreatesaldoawalharga">
                    @csrf
                    <div class="row">
                        <div class="col-12">
...
<script>
    $(function() {
        ...
        $("#formCreatesaldoawalharga").submit(function(e) {
            const form = $("#formCreatesaldoawalharga");
