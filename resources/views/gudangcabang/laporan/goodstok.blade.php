    ...
    <div class="grid grid-cols-1 md:grid-cols-12 gap-x-4 gap-y-1">
        @hasanyrole($roles_show_cabang)
            <div class="md:col-span-12 relative">
                ...
                <select name="kode_cabang_gs" id="kode_cabang_gs" class="w-full pl-10 pr-3 py-2 bg-white border border-slate-200 rounded-lg text-sm focus:outline-none focus:border-[#003d9e] focus:ring-4 focus:ring-[#003d9e]/5 transition-all transition-colors appearance-none select2Kodecabanggs font-medium text-slate-700">
        ...
        <div class="md:col-span-12 relative text-left">
            ...
            <select name="kode_produk_gs" id="kode_produk_gs" class="w-full pl-10 pr-3 py-2 bg-white border border-slate-200 rounded-lg text-sm focus:outline-none focus:border-[#003d9e] focus:ring-4 focus:ring-[#003d9e]/5 transition-all transition-colors appearance-none select2Kodeprodukgs font-medium text-slate-700">
        ...
        <div class="md:col-span-6 relative">
            ...
            <input type="text" name="dari" id="dari_gs" class="w-full pl-10 pr-3 py-2 bg-white border border-slate-200 rounded-lg text-sm placeholder-slate-400 focus:outline-none focus:border-[#003d9e] focus:ring-4 focus:ring-[#003d9e]/5 transition-all font-medium text-slate-700 flatpickr-date" placeholder="Dari">
        </div>
        <div class="md:col-span-6 relative">
            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none text-slate-400">
                <i class="ti ti-calendar"></i>
            </div>
            <input type="text" name="sampai" id="sampai_gs" class="w-full pl-10 pr-3 py-2 bg-white border border-slate-200 rounded-lg text-sm placeholder-slate-400 focus:outline-none focus:border-[#003d9e] focus:ring-4 focus:ring-[#003d9e]/5 transition-all font-medium text-slate-700 flatpickr-date" placeholder="Sampai">
        </div>
    </div>
