                ...
                <tbody>
                    ...
                    @foreach ($mutasi as $d)
                        ...
                        <tr>
                            ...
                            <td class="right">{{ !empty($lainlain_in) ? formatAngkaDesimal($lainlain_in) : '' }}</td>
                            <td class="right">{{ !empty($penyesuaian_in) ? formatAngkaDesimal($penyesuaian_in) : '' }}</td>
                            ...
                            <td class="right">{{ !empty($lainlain_out) ? formatAngkaDesimal($lainlain_out) : '' }}</td>
                            <td class="right">{{ !empty($penyesuaian_out) ? formatAngkaDesimal($penyesuaian_out) : '' }}</td>
