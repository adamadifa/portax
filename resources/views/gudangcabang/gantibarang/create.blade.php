<form action="{{ route('gantibarangcbg.store') }}" method="POST" id="formGantiBarang" autocomplete="off" aria-autocomplete="none" class="flex flex-col h-full">
    @csrf
    ...
    <div class="flex items-center justify-between px-6 py-4 border-b border-slate-200 bg-gradient-to-r from-[#003d9e] to-blue-700">
        <div class="flex items-center gap-3">
            ...
            <div>
                <h3 class="text-lg font-bold text-white">Tambah Ganti Barang Gudang Cabang</h3>
                <p class="text-blue-200 text-xs text-left">Form input data mutasi ganti barang produk</p>
            </div>
        </div>
