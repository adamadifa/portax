...
<div class="flex items-center justify-between px-6 py-4 border-b border-slate-200 bg-gradient-to-r from-[#003d9e] to-blue-700">
    <div class="flex items-center gap-3">
        ...
        <div>
            <h3 class="text-lg font-bold text-white">Detail Reject</h3>
...
<div class="p-6">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 mb-6">
        ...
        <table class="w-full text-sm">
            <tbody>
                <tr class="border-b border-slate-100">
                    ...
                    <td class="py-2.5 text-slate-700 font-semibold">{{ DateToIndo($mutasi->tanggal) }}</td>
                </tr>
                <tr class="border-b border-slate-100 md:border-b-0">
                    <td class="py-2.5 pr-4 text-slate-400 font-medium">Cabang</td>
                    <td class="py-2.5 text-slate-700 font-semibold">{{ textUpperCase($mutasi->nama_cabang) }}</td>
                </tr>
        ...
        <table class="w-full text-sm">
            <tbody>
                <tr class="border-b border-slate-100">
                    <td class="py-2.5 pr-4 text-slate-400 font-medium w-32">Jenis Mutasi</td>
                    <td class="py-2.5 text-slate-700 font-semibold">{{ $mutasi->jenis_mutasi }}</td>
                </tr>
                <tr>
                    <td class="py-2.5 pr-4 text-slate-400 font-medium">Keterangan</td>
                    <td class="py-2.5 text-slate-700 font-semibold">{{ !empty($mutasi->keterangan) ? $mutasi->keterangan : '-' }}</td>
                </tr>
                <tr class="hidden md:table-row">
                    <td class="py-2.5 pr-4"></td>
                    <td class="py-2.5"></td>
