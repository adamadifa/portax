<form action="{{ route('suppliermarketing.update', Crypt::encrypt($supplier->kode_supplier)) }}" id="formeditSupplier" method="POST" class="space-y-4">
    @csrf
    @method('PUT')
    <!-- Header -->
    <div class="border-b border-slate-200 pb-2 mb-2 flex items-center justify-between">
        <h3 class="text-base font-bold text-slate-800">Edit Supplier Marketing</h3>
