<form action="{{ route('cabang.store') }}" id="formcreateCabang" method="POST" class="space-y-3">
    @csrf
    ...
    <div class="border-b border-slate-200 pb-3 mb-3 flex items-center justify-between">
        <h3 class="text-lg font-bold text-slate-800">Tambah Cabang Baru</h3>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        <div class="relative">
            ...
            <input type="text" name="kode_cabang" class="w-full px-3 py-2.5 bg-white border border-slate-300 rounded-lg text-sm placeholder-slate-400 focus:outline-none focus:border-[#003d9e] focus:ring-1 focus:ring-[#003d9e] transition-colors" placeholder="Contoh: TSM">
        </div>

        <!-- Nama Cabang -->
        <div class="relative">
            <label class="absolute -top-2 left-3 bg-white px-1 text-[10px] font-bold text-black z-10">Nama Cabang</label>
            <input type="text" name="nama_cabang" class="w-full px-3 py-2.5 bg-white border border-slate-300 rounded-lg text-sm placeholder-slate-400 focus:outline-none focus:border-[#003d9e] focus:ring-1 focus:ring-[#003d9e] transition-colors" placeholder="Nama Cabang">
        </div>

        <!-- Alamat Cabang -->
        <div class="relative md:col-span-2">
            <label class="absolute -top-2 left-3 bg-white px-1 text-[10px] font-bold text-black z-10">Alamat Cabang</label>
            <textarea name="alamat_cabang" rows="2" class="w-full px-3 py-2.5 bg-white border border-slate-300 rounded-lg text-sm placeholder-slate-400 focus:outline-none focus:border-[#003d9e] focus:ring-1 focus:ring-[#003d9e] transition-colors" placeholder="Alamat Lengkap"></textarea>
        </div>

        <!-- Telepon -->
        <div class="relative">
            <label class="absolute -top-2 left-3 bg-white px-1 text-[10px] font-bold text-black z-10">Telepon</label>
            <input type="text" name="telepon_cabang" class="w-full px-3 py-2.5 bg-white border border-slate-300 rounded-lg text-sm placeholder-slate-400 focus:outline-none focus:border-[#003d9e] focus:ring-1 focus:ring-[#003d9e] transition-colors" placeholder="Nomor Telepon">
        </div>

        <!-- Lokasi (Koordinator) -->
        <div class="relative">
            <label class="absolute -top-2 left-3 bg-white px-1 text-[10px] font-bold text-black z-10">Lokasi (Lat, Long)</label>
            <input type="text" name="lokasi_cabang" class="w-full px-3 py-2.5 bg-white border border-slate-300 rounded-lg text-sm placeholder-slate-400 focus:outline-none focus:border-[#003d9e] focus:ring-1 focus:ring-[#003d9e] transition-colors" placeholder="-7.1234, 108.1234">
        </div>

        <!-- Radius -->
        <div class="relative">
            <label class="absolute -top-2 left-3 bg-white px-1 text-[10px] font-bold text-black z-10">Radius (Meter)</label>
            <input type="text" name="radius_cabang" class="w-full px-3 py-2.5 bg-white border border-slate-300 rounded-lg text-sm placeholder-slate-400 focus:outline-none focus:border-[#003d9e] focus:ring-1 focus:ring-[#003d9e] transition-colors" placeholder="Contoh: 50">
        </div>
        ...
        <div class="relative">
            ...
            <select name="kode_regional" class="w-full px-3 py-2.5 bg-white border border-slate-300 rounded-lg text-sm focus:outline-none focus:border-[#003d9e] focus:ring-1 focus:ring-[#003d9e] transition-colors appearance-none">
                ...
                @foreach ($regional as $r)
                    <option value="{{ $r->kode_regional }}">{{ $r->nama_regional }}</option>
                @endforeach
            </select>
        </div>
        ...
        <div class="relative">
            ...
            <input type="text" name="kode_pt" class="w-full px-3 py-2.5 bg-white border border-slate-300 rounded-lg text-sm placeholder-slate-400 focus:outline-none focus:border-[#003d9e] focus:ring-1 focus:ring-[#003d9e] transition-colors" placeholder="Kode PT">
        </div>

        <!-- Nama PT -->
        <div class="relative">
            <label class="absolute -top-2 left-3 bg-white px-1 text-[10px] font-bold text-black z-10">Nama PT</label>
            <input type="text" name="nama_pt" class="w-full px-3 py-2.5 bg-white border border-slate-300 rounded-lg text-sm placeholder-slate-400 focus:outline-none focus:border-[#003d9e] focus:ring-1 focus:ring-[#003d9e] transition-colors" placeholder="Nama PT">
        </div>

        <!-- Domain -->
        <div class="relative">
            <label class="absolute -top-2 left-3 bg-white px-1 text-[10px] font-bold text-black z-10">Domain</label>
            <input type="text" name="domain" class="w-full px-3 py-2.5 bg-white border border-slate-300 rounded-lg text-sm placeholder-slate-400 focus:outline-none focus:border-[#003d9e] focus:ring-1 focus:ring-[#003d9e] transition-colors" placeholder="domain.com">
        </div>

        <!-- Urutan -->
        <div class="relative">
            <label class="absolute -top-2 left-3 bg-white px-1 text-[10px] font-bold text-black z-10">Urutan</label>
            <input type="number" name="urutan" class="w-full px-3 py-2.5 bg-white border border-slate-300 rounded-lg text-sm placeholder-slate-400 focus:outline-none focus:border-[#003d9e] focus:ring-1 focus:ring-[#003d9e] transition-colors" placeholder="1">
        </div>
        ...
        <div class="relative md:col-span-2">
            ...
            <div class="flex items-center gap-2 p-2 border border-slate-300 rounded-lg mt-1">
                <input type="color" name="color_marker" value="#666EE8" class="h-8 w-16 p-0.5 bg-white border border-slate-300 rounded cursor-pointer">
...
<script>
    $(function() {
        ...
        $("#formcreateCabang").submit(function(e) {
            ...
            $("#formcreateCabang .error-message").remove();
            $("#formcreateCabang input, #formcreateCabang textarea, #formcreateCabang select").removeClass("!border-red-500 invalid-border").addClass("border-slate-300");

            // Helper function to show error
            function showError(field, message) {
                $(field).removeClass("border-slate-300").addClass("!border-red-500 invalid-border");
                // Append error INSIDE the relative container so it stays in the grid cell
            ...
            let kode_cabang = $("#formcreateCabang input[name='kode_cabang']");
            if (kode_cabang.val() == "") {
            ...
            let nama_cabang = $("#formcreateCabang input[name='nama_cabang']");
            if (nama_cabang.val() == "") {
                showError(nama_cabang, "Nama Cabang harus diisi");
            }

             // Validate Alamat Cabang
            let alamat_cabang = $("#formcreateCabang textarea[name='alamat_cabang']");
            if (alamat_cabang.val() == "") {
                showError(alamat_cabang, "Alamat Cabang harus diisi");
            }

            // Validate Telepon
            let telepon_cabang = $("#formcreateCabang input[name='telepon_cabang']");
            ...
            // Validate Lokasi
            let lokasi_cabang = $("#formcreateCabang input[name='lokasi_cabang']");
            if (lokasi_cabang.val() == "") {
                showError(lokasi_cabang, "Lokasi harus diisi");
            }

            // Validate Radius
            let radius_cabang = $("#formcreateCabang input[name='radius_cabang']");
            if (radius_cabang.val() == "") {
                showError(radius_cabang, "Radius harus diisi");
            }

            // Validate Regional
            let kode_regional = $("#formcreateCabang select[name='kode_regional']");
            if (kode_regional.val() == "") {
                showError(kode_regional, "Silahkan pilih regional");
            }

            // Validate Kode PT
            let kode_pt = $("#formcreateCabang input[name='kode_pt']");
            if (kode_pt.val() == "") {
            ...
            // Validate Nama PT
            let nama_pt = $("#formcreateCabang input[name='nama_pt']");
            if (nama_pt.val() == "") {
                showError(nama_pt, "Nama PT harus diisi");
            }

            // Validate Urutan
            let urutan = $("#formcreateCabang input[name='urutan']");
            if (urutan.val() == "") {
        ...
        $("#formcreateCabang input, #formcreateCabang textarea, #formcreateCabang select").on('input change', function() {
