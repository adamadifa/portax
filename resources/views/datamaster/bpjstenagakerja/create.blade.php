<form action="{{ route('bpjstenagakerja.store') }}" aria-autocomplete="false" id="formcreateBpjstenagakerja" method="POST">
    @csrf
...
<script src="{{ asset('assets/js/pages/bpjstenagakerja/create.js') }}"></script>
<script>
    $(function() {
